...
public class TabOne {
    ...
    final Double BUTTON_WIDTH = 70.0;

    public Pane createTab(Stage primaryStage) {
...
//        btnSetting.setMaxWidth(btnGridPane.getPrefWidth());
        btnStop.setPrefWidth(BUTTON_WIDTH);
        btnAdd.setPrefWidth(BUTTON_WIDTH);
        btnClear.setPrefWidth(BUTTON_WIDTH);
        btnSetting.setPrefWidth(BUTTON_WIDTH);
        btnStop.setPrefWidth(BUTTON_WIDTH);

//        btnStart.setMaxWidth(double.);

        btnGridPane.add(btnStart, 0, 0);
        btnGridPane.add(btnStop, 0, 1);
        btnGridPane.add(btnAdd, 0, 2);
        btnGridPane.add(btnClear, 0, 3);
        btnGridPane.add(btnSetting, 0, 4);
